...
<title>Sign up with PaNyaPal Payment Step </title><!--for buy it now -->
<style type="text/css">
<!--
body {
...
<div class="container">
  <div class="sidebar1">
    <ul class="nav">
      ...
      <li><a href="#"> Go to paNya.com</a></li>
    </ul>
    <!-- end .sidebar1 --></div>
<div class="content">
  <h1><span class="pad">Register to Sell with paNyaPal</span></h1>
    <p class="pad">&nbsp;</p>
<div class="block1">
  <p class="secondh1">You have Succesfully Logged in your PaNyaPal Account</p>
    <p class="smallfont">PaNyaPay will regularly send you the payments you receive from your buyers. These payments are transferred online to your bank account, so you face no hassles or security risks in receiving your money.</p>
    <p class="pad">&nbsp;</p>
</div>
<p class="pad">&nbsp;    </p>
    <p class="pad">&nbsp;</p>
