...
<div id="templatemo_wrapper">
	...
	<li class="toplast"><a href="PaginationServlet?cat=Miscellaneous" style="width:130px;"><span>Miscellaneous</span></a></li>
        	...
        	%>
        <div id="content">
        	<!-- <h2><%=request.getParameter("value") %></h2> -->
        	<h2><%=arrayList.get(0) %></h2>
        	<div class="col col_14 product_gallery">
        	<%String maincat=request.getParameter("cat"); %>
        	<% System.out.println(arrayList.get(0).substring(0,3)+"_");
        		System.out.println("Concat"+"images/product/images/"+maincat+"/"+arrayList.get(0).substring(0,3)+"_i00001.jpg");
        	%>
            	<a href="productdetail.jsp"  ><img src="images/product/images/<%=maincat%>/<%=arrayList.get(0).substring(0,3)+"_" %>i00001.jpg" alt="Product 01" /></a>
                <h3>product data</h3>
                <p class="product_price">$ 100</p>
                <a href="shoppingcart.jsp" class="add_to_cart">Add to Cart</a>
            </div>        	
            <div class="col col_14 product_gallery">
            	<a href="productdetail.jsp"><img src="images/product/images/<%=maincat%>/<%=arrayList.get(0).substring(0,3)+"_" %>i00002.jpg" alt="Product 02" /></a>
                <h3>product data</h3>
                <p class="product_price">$ 200</p>
                <a href="shoppingcart.jsp" class="add_to_cart">Add to Cart</a>
            </div>        	
            <div class="col col_14 product_gallery no_margin_right">
            	<a href="productdetail.jsp"><img src="images/product/images/<%=maincat%>/<%=arrayList.get(0).substring(0,3)+"_" %>i00003.jpg" alt="Product 03" /></a>
                <h3>product data</h3>
                <p class="product_price">$ 120</p>
                <a href="shoppingcart.jsp" class="add_to_cart">Add to Cart</a>
            </div>
            <a href="PaginationServlet2?subcat=<%=arrayList.get(0) %>&cat=<%=request.getParameter("cat") %>" class="more float_r">View all</a>
			<div class="cleaner h50"></div>
            
            <h2><%=arrayList.get(1) %></h2>
            <div class="col col_14 product_gallery">
            	<a href="productdetail.jsp"  ><img src="images/product/images/<%=maincat%>/<%=arrayList.get(1).substring(0,3)+"_" %>i00001.jpg" alt="Product 01" /></a>
                <h3>product data</h3>
                <p class="product_price">$ 100</p>
                <a href="shoppingcart.jsp" class="add_to_cart">Add to Cart</a>
            </div>        	
            <div class="col col_14 product_gallery">
            	<a href="productdetail.jsp"><img src="images/product/images/<%=maincat%>/<%=arrayList.get(1).substring(0,3)+"_" %>i00002.jpg" alt="Product 02" /></a>
                <h3>product data</h3>
                <p class="product_price">$ 200</p>
                <a href="shoppingcart.jsp" class="add_to_cart">Add to Cart</a>
            </div>        	
            <div class="col col_14 product_gallery no_margin_right">
            	<a href="productdetail.jsp"><img src="images/product/images/<%=maincat%>/<%=arrayList.get(1).substring(0,3)+"_" %>i00003.jpg" alt="Product 03" /></a>
                <h3>product data</h3>
                <p class="product_price">$ 120</p>
                <a href="shoppingcart.jsp" class="add_to_cart">Add to Cart</a>
            </div>
            ...
            <div class="col col_14 product_gallery">
            	<a href="productdetail.jsp"><img src="images/product/images/<%=maincat%>/<%=arrayList.get(2).substring(0,3)+"_" %>i00001.jpg"" alt="Product 07" /></a>
                <h3>product data</h3>
                <p class="product_price">$ 30</p>
                <a href="shoppingcart.jsp" class="add_to_cart">Add to Cart</a>
            </div>        	
            <div class="col col_14 product_gallery">
            	<a href="productdetail.jsp"><img src="images/product/images/<%=maincat%>/<%=arrayList.get(2).substring(0,3)+"_" %>i00001.jpg"" alt="Product 08" /></a>
                <h3>product data</h3>
                <p class="product_price">$ 220</p>
                <a href="shoppingcart.jsp" class="add_to_cart">Add to Cart</a>
            </div>        	
            <div class="col col_14 product_gallery no_margin_right">
            	<a href="productdetail.jsp"><img src="images/product/images/<%=maincat%>/<%=arrayList.get(2).substring(0,3)+"_" %>i00001.jpg"" alt="Product 09" /></a>
                <h3>product data</h3>
