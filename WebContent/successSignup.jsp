...
<div id="templatemo_wrapper">
	...
	<li class="toplast"><a href="PaginationServlet?cat=Miscellaneous" style="width:130px;"><span>Miscellaneous</span></a></li>
        ...
        <p><h3>You have successfully created account on paNya.com .<br></br>
        </h3><h3> Buy and sell anything from anywhere.</h3><br />
          <br />
           <br />
         <h4 style="font-family:verdana;color:red">Now you will receive one confirmation mail.Click on link given in mail to complete the procedure.</h4>
         <h4 style="font-family:verdana;color:red"> If you did not received mail ,<a href="#" style="font-family:verdana;color:buttontext">click here</a></h4></style>
